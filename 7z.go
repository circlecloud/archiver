...
// Archive is not implemented for 7z, but the method exists so that Rar satisfies the ArchiveFormat interface.
func (r SevenZip) Archive(_ context.Context, _ io.Writer, _ []File) error {
	return fmt.Errorf("not implemented because 7z is a proprietary format")
}
